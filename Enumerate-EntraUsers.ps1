...
Write-Host ("`n" + ("=" * 70)) -ForegroundColor Cyan
Write-Host "    Azure Entra ID User Enumeration - Ultimate Edition" -ForegroundColor Cyan
Write-Host ("=" * 70) -ForegroundColor Cyan
Write-Host "`nThis script includes ALL enumeration methods for restricted environments."
